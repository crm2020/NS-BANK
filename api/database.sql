...
CREATE TABLE `Pincodes`  (
  ...
  CONSTRAINT `Pincodes_ibfk_1` FOREIGN KEY (`Account_IBAN`) REFERENCES `Account` (`CardID`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `Transactions`  (
  ...
  INDEX `Account_IBAN`(`Account_IBAN` ASC) USING BTREE,
  CONSTRAINT `Transactions_ibfk_1` FOREIGN KEY (`Cards_Account_IBAN`) REFERENCES `Account` (`IBAN`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
